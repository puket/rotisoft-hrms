...
Route::get('/', function () {
    ...
    // ==========================================
    // 👑 โซนของเจ้าของ RotiSoft เท่านั้น
    // ==========================================
    ...
    // ==========================================
    // 🏢 โซนของ HR / แอดมินบริษัทลูกค้า (Tenant Admin)
    // ==========================================
    Route::middleware(['auth', 'can:access-admin'])->group(function () {
        // แอดมินบริษัท สามารถจัดการ แผนก และ ตำแหน่ง ของบริษัทตัวเองได้
        ...
        // ... (Route อื่นๆ ของ access-admin เช่น ot-settings ให้อยู่ในกลุ่มนี้ตามเดิมครับ) ...
    });
